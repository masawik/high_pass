...
(function dropdownMenu() {
  ...
  const dropdownMenuTl = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline({paused: true})
  ...
  const open = () => {
    _utils_js__WEBPACK_IMPORTED_MODULE_0__.Overflow.disable()
  ...
  const close = () => {
    ...
    _utils_js__WEBPACK_IMPORTED_MODULE_0__.Overflow.enable()
  }
...
//Order form
{
  const validate = new just_validate__WEBPACK_IMPORTED_MODULE_0__["default"]('.order-form-js', validateOptions);
  validate
...
{
  const validate = new just_validate__WEBPACK_IMPORTED_MODULE_0__["default"]('.subscribe-form-js', validateOptions)
  validate
...
class Map {
  ...
  async initializeMap() {
    try {
      this.maps = await ymaps__WEBPACK_IMPORTED_MODULE_0__["default"].load('https://api-maps.yandex.ru/2.1/?lang=ru_RU')
  ...
  initializeAnimation() {
    const mapInfoTl = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({paused: true, defaults: {duration: 0.3}})
...
(function searchForm() {
  ...
  const searchFormTl = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({paused: true})
...
const setTabIndex = ($el, value) => $el.tabIndex = value
...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vendor_modernizr_webp_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vendor/modernizr-webp.js */ "./src/js/vendor/modernizr-webp.js");
/* harmony import */ var _searchForm_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./searchForm.js */ "./src/js/searchForm.js");
/* harmony import */ var _dropdownMenu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dropdownMenu.js */ "./src/js/dropdownMenu.js");
/* harmony import */ var _map_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./map.js */ "./src/js/map.js");
/* harmony import */ var _updateCopyright_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./updateCopyright.js */ "./src/js/updateCopyright.js");
/* harmony import */ var _formsValidation_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./formsValidation.js */ "./src/js/formsValidation.js");
